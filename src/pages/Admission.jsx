...
import admissionIcon01 from '../assets/img/icon/am_01.svg';
import admissionIcon02 from '../assets/img/icon/am_02.svg';
import admissionIcon03 from '../assets/img/icon/am_03.svg';
import stampImg from '../assets/img/shape/stamp.png';
import capImg from '../assets/img/shape/cap.png';
import testimonialImg from '../assets/img/testimonial/tes-img.png';
import testimonialImg04 from '../assets/img/testimonial/tes-img04.png';
import testimonialImg02 from '../assets/img/testimonial/tes-img02.png';
import testimonialImg03 from '../assets/img/testimonial/tes-img03.png';

import quaIcon from '../assets/img/icon/qua.png';
import tesShape from '../assets/img/shape/tes-shape.png';
import tesShape02 from '../assets/img/shape/tes-shape02.png';
import fanfactBgImg from '../assets/img/bg/fanfact_bg.jpg';
import ctaImg1 from '../assets/img/cta/cta_img1.jpg';
import ctaImg2 from '../assets/img/cta/cta_img2.jpg';
import ctaIcon01SVG from '../assets/img/icon/cta_icon_01.svg';
import ctaIcon02SVG from '../assets/img/icon/cta_icon_02.svg';
       ...
       return (
           <div className="body_wrap">   
               <main>
                   <section className="breadcrumb bg_img ul_li" style={{ backgroundImage: `url(${breadcrumbBg})` }}>
                        <div className="container">
                            <div className="breadcrumb__content text-center">
                               <h2 className="breadcrumb__title">Admission to edubost</h2>
                               <p className="breadcrumb__desc">Your Pathway to Joining Our Academic Community</p>
                            </div>
                        </div>
                   </section>
                   
                   <section className="admission pt-120 pb-120">
                       <div className="container">
                           <div className="row align-items-center mt-none-30">
                               <div className="col-xl-5 mt-30">
                                   <div className="section-title section-title--md">
                                       <span className="sub-title">Our Dedicated instructor</span>
                                       <h2 className="title mb-20">experience eedford with excellent academics and endless opportunities</h2>
                                       <p>As a public institution, EduFord University is to fostering positive change through education. We are committed</p>
                                   </div>
                                   <div className="admission-btn mt-65">
                                       <a className="thm-btn" href="contact.html">apply now
                                           <span className="icon"><svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                               ...
                               <div className="col-xl-6 offset-xl-1 mt-30">
                                   <div className="admission-iconbox">
                                       <div className="admission-iconbox-item ul_li">
                                           <div className="xb-item--icon">
                                               <img src={admissionIcon01} alt="" />
                                           </div>
                                           <div className="xb-item--holder">
                                               <h3 className="xb-item--title">Choose from hundreds of programs.</h3>
                                               <p className="xb-item--content">Choose from hundreds of programs" highlights the diverse range of academic options available.</p>
                                           </div>
                                       </div>
                                       <div className="admission-iconbox-item ul_li">
                                           <div className="xb-item--icon">
                                               <img src={admissionIcon02} alt="" />
                                           </div>
                                           <div className="xb-item--holder">
                                               <h3 className="xb-item--title">Customize your University experience.</h3>
                                               <p className="xb-item--content">Customize your university experience available to tailor your education your individual needs.</p>
                                           </div>
                                       </div>
                                       <div className="admission-iconbox-item ul_li">
                                           <div className="xb-item--icon">
                                               <img src={admissionIcon03} alt="" />
                                           </div>
                                           <div className="xb-item--holder">
                                               <h3 className="xb-item--title">Choose from hundreds of programs.</h3>
                                               <p className="xb-item--content">Choose from hundreds of programs" highlights the diverse range of academic options available.</p>
                   ...
                   <section className="department pt-115 pb-90 pos-rel">
                       <div className="container">
                           <div className="section-title text-center mb-35">
                               <span className="sub-title">Our academics offerings</span>
                               <h1 className="title">Our Top Department</h1>
                           </div>
                           <div className="dep-inner dep-inner-two pos-rel">
                               <div className="row g-0">
                                   <div className="col-lg-3 col-md-6 mt-30 mb-30 dp-col">
                                       <div className="xb-dep-wrapper">
                                           <div className="xb-department text-center pos-rel">
                                               <div className="xb-item--icon">
                                                   <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                       <path fillRule="evenodd" clipRule="evenodd" d="M26.3771 29.7074C30.2873 26.775 32.8581 22.1506 32.9935 16.9295H17.3361L26.3771 29.7074ZM16.0673 16.4971C16.0673 16.5901 16.0969 16.6758 16.1473 16.7465L16.1466 16.7472L25.6724 30.2075C23.0476 31.9702 19.8918 33 16.4996 33C7.40178 33 0 25.5968 0 16.4971C0 7.5416 7.16834 0.229887 16.0673 0V16.4971ZM20.1087 16.0647V9.81886H16.9319V16.0647H20.1087ZM26.5536 16.0647V5.73709H23.3776V16.0647H26.5536ZM29.8226 16.0647H33V1.3541H29.8226V16.0647Z" fill="white" />
                                                   </svg>
                                               </div>
                                               <h3 className="xb-item--title">Economics</h3>
                                               <span>Course: 20</span>
                                               <a className="div-link" href="course-single.html"></a>
                                           </div>
                                           <div className="xb-department text-center pos-rel">
                                               <div className="xb-item--icon">
                                               ...
                                               <h3 className="xb-item--title">Medical</h3>
                                               <span>Course: 22</span>
                                               <a className="div-link" href="/course-single"></a>
                                           </div>
                                       </div>
                                   </div>
                                   <div className="col-lg-3 col-md-6 mt-30 mb-30 dp-col">
                                       <div className="xb-dep-wrapper">
                                           <div className="xb-department text-center pos-rel">
                                               ...
                                               <h3 className="xb-item--title">Technology</h3>
                                               <span>Course: 18</span>
                                               <a className="div-link" href="course-single.html"></a>
                                           </div>
                                           <div className="xb-department text-center pos-rel">
                                               ...
                                               <h3 className="xb-item--title">Mathematics</h3>
                                               <span>Course: 26</span>
                                               <a className="div-link" href="course-single.html"></a>
                                           </div>
                                       </div>
                                   ...
                                   <div className="col-lg-3 col-md-6 mt-30 mb-30 dp-col">
                                       <div className="xb-dep-wrapper">
                                           <div className="xb-department text-center pos-rel">
                                               ...
                                               <h3 className="xb-item--title">Science</h3>
                                               <span>Course: 22</span>
                                               <a className="div-link" href="course-single.html"></a>
                                           </div>
                                           <div className="xb-department text-center pos-rel">
                                   ...
                                   <div className="col-lg-3 col-md-6 mt-30 mb-30 dp-col">
                                       <div className="xb-dep-wrapper">
                                           <div className="xb-department text-center pos-rel">
                                               ...
                                               <h3 className="xb-item--title">Research</h3>
                                               <span>Course: 17</span>
                                               <a className="div-link" href="course-single.html"></a>
                                           </div>
                                           <div className="xb-department text-center pos-rel">
                                               ...
                                               <h3 className="xb-item--title">Health & Fitness</h3>
                                               <span>Course: 18</span>
                                               <a className="div-link" href="course-single.html"></a>
                                           </div>
                                       </div>
                           ...
                           <div className="xb-feature-shape">
                               <span className="shape shape--one"><img data-parallax='{"x":-50,"y":-80}' src={stampImg} alt="" /></span>
                               <span className="shape shape--two"><img data-parallax='{"x":50,"y":80}' src={capImg} alt="" /></span>
                           </div>
                       </div>
                   </section>
                   ...
                   <section className="testimonial pt-120 pb-120 pos-rel">
                       <div className="container">
                           <div className="row align-items-center mt-none-30">
                               <div className="col-lg-6 mt-30">
                                   <div className="xb-testimonial-left pos-rel">
                                       ...
                                       <div className="testimonial-slider-nav swiper-container">
                                           <div className="swiper-wrapper">
                                               <div className="swiper-slide">
                                       ...
                                       <div className="testimonial-carousel">
                                           <div className="xb-swiper-arrow xb-swiper-arrow-next"><i className="far fa-angle-down"></i></div>
                                           <div className="xb-swiper-arrow xb-swiper-arrow-prev"><i className="far fa-angle-up"></i></div>
                                       </div>
                                   </div>
                               </div>
                               <div className="col-lg-6 mt-30">
                                   <div className="xb-testimonial-right">
                                           ...
                                           <div className="swiper-wrapper">
                                               <div className="swiper-slide">
                                                   <div className="xb-item--holder">
                                                       ...
                                                       <p className="xb-item--content">"Edubost University has been a game-changer for me. The expert faculty, practical learning experiences, and supportive community have prepared me well for my career. The campus life and top-notch facilities."</p>
                                                   </div>
                                                   <div className="xb-item--author mt-60">
                                                       <span className="xb-item--name">Dr. William Harris</span>
                                                       <span className="xb-item--desig">Dean of Humanities</span>
                                                   </div>
                                               </div>
                                               <div className="swiper-slide">
                                                   <div className="xb-item--holder">
                                                   ...
                                                   <div className="xb-item--author mt-60">
                                                       <span className="xb-item--name">Jessica Taylor</span>
                                                       <span className="xb-item--desig">Student Council President</span>
                                                   </div>
                                               </div>
                                               <div className="swiper-slide">
                                                   <div className="xb-item--holder">
                                                   ...
                                                   <div className="xb-item--author mt-60">
                                                       <span className="xb-item--name">Ryan Stewart</span>
                                                       <span className="xb-item--desig">IT Services Manager</span>
                                                   </div>
                                               </div>
                                               <div className="swiper-slide">
                                                   <div className="xb-item--holder">
                                                   ...
                                                   <div className="xb-item--author mt-60">
                                                       <span className="xb-item--name">Sarah Parker</span>
                                                       <span className="xb-item--desig">Student Affairs Coordinator</span>
                                                   </div>
                                               </div>
                                           </div>
                                       </div>
                       ...
                       <div className="xb-tes-shape">
                           <span className="shape shape--one"><img src={tesShape} alt="" /></span>
                           <span className="shape shape--two"><img src={tesShape02} alt="" /></span>
                       </div>
                   </section>

                   <section class="funfact" data-bg-color="#F1F1E9" style={{ backgroundColor: '#F1F1E9' }}>
                       <div class="funfact-image">
                           <img src={fanfactBgImg} alt="" />
                       </div>
                       <div class="container">
                           <div class="funfact-inner ul_li_between">
                               <div class="funfact-item mt-30">
                                   <h3 class="xb-item--title">3.97<span>cGPA</span></h3>
                                   <p class="xb-item--contact">Edubost Arizona first-year <br /> cohort has a record 3.97 GPA.</p>
                               </div>
                               <div class="funfact-item mt-30">
                                   <h3 class="xb-item--title">82%<span>aid</span></h3>
                                   <p class="xb-item--contact">Of undergraduate students <br /> receive financial aid.</p>
                               </div>
                               <div class="funfact-item mt-30">
                                   <h3 class="xb-item--title">157<span>country</span></h3>
                                   <p class="xb-item--contact">157 countries and all 50 states <br /> represented at edubost.</p>
                               </div>
                           </div>
                       </div>
                   </section>

                   <section className="cta pt-120 pb-120" data-bg-color="#F1F1E9" style={{ backgroundColor: '#F1F1E9' }}>
                       <div className="container">
                           <div className="row mt-none-30">
                               <div className="col-lg-6 mt-30">
                                   <div className="cta-item pos-rel" style={{ backgroundImage: `url(${ctaImg1})` }}>
                                       <div className="cta-inner">
                                           <div className="xb-item--icon">
                                               <img src={ctaIcon01SVG} alt="Financial aid icon" />
                                           </div>
                                           <h3 className="xb-item--title">Cost and financial aid</h3>
                                           <p className="xb-item--content">Understanding the cost and financial aid options for higher education is crucial for effective budgeting and planning.</p>
                                           <a className="thm-btn thm-btn--gray" href="contact.html">apply now
                                               <span>
                                                   <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                       <path fillRule="evenodd" clipRule="evenodd" d="M16.25 19.4919V20.7499C16.25 21.1639 15.914 21.4999 15.5 21.4999C15.086 21.4999 14.75 21.1639 14.75 20.7499V19.4999H16C16.084 19.4999 16.167 19.4969 16.25 19.4919Z" fill="#170006" />
                                                       <path fillRule="evenodd" clipRule="evenodd" d="M14.75 19.5H8C5.929 19.5 4.25 17.821 4.25 15.75V12.668L9.964 15.825C11.202 16.509 12.798 16.509 14.036 15.825L14.75 15.431V19.5ZM16.25 14.602L19.75 12.668V15.75C19.75 17.737 18.205 19.363 16.25 19.492V14.602Z" fill="#170006" />
                                                       <path fillRule="evenodd" clipRule="evenodd" d="M14.75 14.2879L13.552 14.9499C12.608 15.4719 11.392 15.4719 10.448 14.9499L2.134 10.3559C1.568 10.0429 1.25 9.49495 1.25 8.92195C1.25 8.34795 1.568 7.79995 2.134 7.48795L10.448 2.89295C11.392 2.37195 12.608 2.37195 13.552 2.89295L21.866 7.48795C22.432 7.79995 22.75 8.34795 22.75 8.92195C22.75 9.49495 22.432 10.0429 21.866 10.3559L16.25 13.4589V12.7499C16.25 12.5509 16.171 12.3599 16.03 12.2199L12.53 8.71995C12.238 8.42695 11.762 8.42695 11.47 8.71995C11.177 9.01195 11.177 9.48795 11.47 9.77995L14.75 13.0609V14.2879Z" fill="#170006" />
                                                   </svg>
                                               </span>
                                           </a>
                                       </div>
                               ...
                               <div className="col-lg-6 mt-30">
                                   <div className="cta-item pos-rel" style={{ backgroundImage: `url(${ctaImg2})` }}>
                                       <div className="cta-inner">
                                           <div className="xb-item--icon">
                                               <img src={ctaIcon02SVG} alt="Campus visit icon" />
                                           </div>
                                           <h3 className="xb-item--title">Visit our campus</h3>
                                           <p className="xb-item--content">"Visit Our Campus" invites prospective students and their families to experience our academic environment firsthand.</p>
                                           <a className="thm-btn thm-btn--gray" href="contact.html">apply now
                                               <span>
                                                   <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                       <path fillRule="evenodd" clipRule="evenodd" d="M16.25 19.4919V20.7499C16.25 21.1639 15.914 21.4999 15.5 21.4999C15.086 21.4999 14.75 21.1639 14.75 20.7499V19.4999H16C16.084 19.4999 16.167 19.4969 16.25 19.4919Z" fill="#170006" />
